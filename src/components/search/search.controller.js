(function () {
    ...
    function searchCtrl($scope, velooData, searchService, $routeParams, $rootScope, $location, $mdDialog) {
        var vm = this;
        ...
        function availableFilterEndDate(date) {
            ...
            if (vm.searchFilter.startDate) {
                var startDate = new Date();
                startDate.setDate(vm.searchFilter.startDate.getDate());
